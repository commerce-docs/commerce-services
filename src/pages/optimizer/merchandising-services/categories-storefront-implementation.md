...
#### Example: Retrieve product categories with breadcrumb ancestors
...
#### Example: Filter product categories by family
...
### Example: Retrieve category details with metadata and images
